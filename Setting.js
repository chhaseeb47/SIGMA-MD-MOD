...
global.owner = process.env.OWNER_NUMBER  || '923175879795;923462054847' ;  // ADD YOUR NUMBER WITHOUT +
...
global.sudo  =  process.env.SUDO || "923175879795;923462054847" ;          // DON'T REMOVE
...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://telegra.ph/file/b94cbae6378140fe34577.jpg' ;
//=================================================================================
...
module.exports = {
  ...
  botname: process.env.BOT_NAME       || '𝛨𝛥𝑆𝛪 𝛭𝐷',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `𝐶𝛨 𝛨𝛥𝑆𝛯𝛯𝐵`, // ADD YOUR NAME
  ...
  //==============================[WHAT'SAPP FEATURES]==============================
  author:  process.env.PACK_AUTHER  || '𝐻𝐴𝑆𝐼 𝑀𝐷',      // ADD YOUR STICKER AUTHOR NAME
  ...
  packname:  process.env.PACK_NAME  || "𝐶𝛨 𝛨𝛥𝑆𝛯𝛯𝐵" ,          // ADD YOUR STICKER PACKNAME
  ...
  caption :process.env.CAPTION || "*• 𝐻𝐴𝑆𝐼 𝑀𝐷*\n*𝐶𝛨 𝛨𝛥𝑆𝛯𝛯𝐵* ",
